...
public:
    ...
    //overloaded Insert function which is used in the recursive call
    ...
    //overloaded function which is called during the recursive call from removeNode(string)
    bool removeNode(Node* root,string key);
